...
public class List01 {
	...
	public static void main(String[] args) {
		...
		//add :요소를 추가
		list.add(1);  //오토 박싱 : int =>Integer 박싱돼서 저장
		...
		System.out.println(list.get(1));   //arr[1] 같은 의미
		System.out.println(list.get(2));   //arr[2] 같은 의미
		...
		//list1을 생성하여, 1~10까지 추가하고 출력 ( for문 이용 )

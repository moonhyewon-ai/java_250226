...
public class Abstract01 {
	...
	public static void main(String[] args) {
		 ...
		 * 추상클래스는 미완성클래스이기 때문에 객체를 생성할 수 없다.
		 * 키워드 : abstract
...
class Cat extends Animal{
	...
	@Override
	public void howl() {
		System.out.println(super.name+"울음소리 : 냐옹!!");
	}
...
abstract class Animal{
	protected String name;          //private > protected 로 하면 getter/setter 안 넣어도 됨 (왜?)
